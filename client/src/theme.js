...
const FOOTER_BANNER_HEIGHT = '90px'
const CARD_VIDEO_HEIGHT = `calc(100vh - (${APP_BAR_HEADER_HEIGHT} + ${APP_BAR_MARQUEE_HEIGHT} + ${APP_BAR_BANNER_HEIGHT} + ${FOOTER_BANNER_HEIGHT}))` 
