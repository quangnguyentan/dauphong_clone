...
function CustomGrid({ size, flexDirectionStyle, headerBox }) {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <Box sx={{ p : 0.5, mb : 2, width : '82%', border : 1, borderColor : 'white', bgcolor : 'rgb(254 179 7)', borderRadius : '5px', fontSize : '13px', fontWeight : 600, display : headerBox ? { md : 'flex' , xs : 'none'} : 'none' , justifyContent : 'center' }}>
        CÁC TRẬN HOT
      </Box>
       {size > 3 ?  <Box sx={{flexDirection : {  md :  flexDirectionStyle ? 'column' : ''},  display : { xs : 'none', md : 'flex', listStyle : 'none'}, }}>
